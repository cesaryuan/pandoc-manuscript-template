...
本文的主要贡献包括三个方面。第一，提出[描述第一项贡献]。第二，给出[描述第二项贡献]。第三，证明[描述第三项贡献]。本文其余部分安排如下：@sec:methods 介绍研究方法，@sec:results 展示实验结果，[@sec:discussion] 讨论研究发现及局限性，@sec:conclusion 总结全文。
