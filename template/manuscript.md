...
![An SVG-based multi-panel layout whose child panels are referenced by relative image paths inside the SVG file.](figures/subfigure-svg-layout-example.svg){#fig:subfigure-svg-example width=90% to-png=true}
